    ...
    >
      ...
      >
        <a href="#home" className="group flex items-center gap-2.5">
          <span className="flex h-9 w-9 shrink-0 items-center justify-center rounded-xl bg-foreground font-mono text-xs font-black text-background tracking-tighter transition-transform duration-300 group-hover:scale-105">
            AR<span className="text-accent text-[8px] leading-none">●</span>
          </span>
        </a>
